...
HATS.22.1.0.MM.zip = Full HATS without firmware update

HATS.22.1.0.MM+FW.zip = Full HATS with firmware update (22.0.1) only needed if your on old system firmware.
